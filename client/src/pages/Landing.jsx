        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center text-white">
            <div className="flex justify-center items-center mb-6">
              <BsGlobeCentralSouthAsia className="w-16 h-16 mr-4" />
            ...
            <div className="space-x-4">
              <Button 
                size="lg" 
                className="bg-white text-news-blue hover:bg-gray-100 cursor-pointer"
                onClick={handleLogin}
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-none cursor-pointer text-white bg-black hover:bg- hover:text-news-blue"
              >
                Learn More
              </Button>
            </div>
